...
const Features = () => {
  ...
  return (
    <section className="relative bg-[#020817] py-24 overflow-hidden">
      {/* Background Overlays */}
      <img
        src={techLines}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, i) => (
            <div
              key={i}
              className="group p-8 rounded-3xl bg-[#0A0F1C]/60 border border-white/5 backdrop-blur-sm hover:border-[#2E7CF6]/30 transition-all duration-300"
            >
              {/* Icon Container */}
              <div className="w-12 h-12 rounded-xl bg-[#1D2433] flex items-center justify-center mb-6 border border-white/10 group-hover:bg-[#2E7CF6]/10 group-hover:border-[#2E7CF6]/20 transition-colors">
                <feature.icon className="w-6 h-6 text-[#2E7CF6]" />
              </div>
